...
describe('customUtils', function () {
  ...
  describe('convertDotToObj', function () {
    ...
    it('Should convert an object with multiple dot notations' , function () {
      var input = {
          'addresses.home.number':1,
          'addresses.home.address':'somewhere',
          'phones.work.available':true
        }
        , expectedResult = {
          addresses:{
            home:{
  ...
  describe('pick', function () {
    ...
    it('Should leave the source doc intact after selection of properties', function () {
      var sourceCopy = {   // Create a copy of the source doc
        num:4,
        foo:'bar',
        blean:false,
        addresses:{
  ...
  describe('getFieldPath', function () {
    ...
    it('Should return whole embedded doc correctly', function () {
      var path = 'addresses';
      customUtils.getFieldPath(inputDoc, path).should.deep.equal({
        home:{
          number:56,
          address:'somewhere'
        }
