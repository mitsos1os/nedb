...
/**
 * Thi function will accept an object whose properties can be set a dot notated fields. It will transform it into
...
function pick (doc,projection,query){
  ...
  var key, keyValue, docValue, tmpDoc;
  while (i--){   // Browse projection properties...
    ...
    if (typeof doc[key] === 'undefined') continue;   // Move on to next property
